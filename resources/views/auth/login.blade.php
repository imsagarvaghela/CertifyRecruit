...
<div class="split left">
    ...
    <img src="{{ url('storage/images/login1.png') }}" class="img-fluid" alt="Register Image">
</div>

<div class="split right">
    <div class="centered">
        <form class="p-4 rounded" method="POST" action="{{ route('login') }}">
            @csrf
            ...
            <div class="form-group mb-4">
                ...
                <input type="email" id="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Enter a valid email address" autofocus>
                @error('email')
            ...
            <p class="text-center mt-4 mb-0">Don't have an account? <a href="{{ route('register') }}" class="text-danger text-decoration-none">Register</a></p>
